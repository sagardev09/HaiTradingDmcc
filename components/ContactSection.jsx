        ...
        <div className="w-full max-w-7xl mx-auto px-4 mt-16">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-secondary md:text-lg max-w-2xl mx-auto">
              Let's discuss how we can help grow your business with our proven
              solutions
            </p>
          </div>
              ...
              <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 h-full">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                      <h3 className="font-medium text-sm text-zinc-600 dark:text-slate-400 mb-1">
                        Email
                      </h3>
                      <a
                        href="mailto:Muzaffar@haidmcc.com"
                        className="text-base text-black dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors"
                      >
                  ...
                  <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-base text-black dark:text-white hover:text-green-600 dark:hover:text-green-400 transition-colors block"
                      >
                        +971 4 575 4755
                      </a>
                      <a
