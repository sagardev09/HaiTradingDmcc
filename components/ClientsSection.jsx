...
export default function ClientsSection() {
  ...
  const countries = [
    ...
    },
    {
      ...
      flag: "🇸🇴",
      established: "2017",
      products: ["Wheat Flour", "Rice", "Spices"],
    },
    {
      name: "Somaliland",
      region: "East Africa",
    ...
    },
    {
      ...
      flag: "🇰🇪",
      established: "2016",
      products: ["Rice", "Sunflower Oil", "Dry Nuts"],
    },
    {
      name: "Tanzania",
      region: "East Africa",
      flag: "🇹🇿",
      established: "2019",
      products: ["Wheat Flour", "Sugar", "Palm Oil"],
    },
    {
      name: "Uganda",
      region: "East Africa",
      flag: "🇺🇬",
      established: "2020",
      products: ["Rice", "Spices", "Sunflower Oil"],
    },
    {
      name: "Djibouti",
      region: "East Africa",
    ...
    },
    {
      ...
      flag: "🇨🇲",
      established: "2017",
      products: ["Rice", "Palm Oil", "Wheat Flour"],
    },
    {
      name: "Togo",
      region: "West Africa",
      flag: "🇹🇬",
      established: "2019",
      products: ["Sugar", "Sunflower Oil", "Rice"],
    },
  ];
        ...
        <div className="w-full max-w-7xl mx-auto px-4 mt-16">
          ...
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-black rounded-full mb-6">
              <Globe className="size-5 text-primary00" />
              <span className="text-sm font-medium text-primary">
                Serving Africa with Excellence
              </span>
            </div>
            ...
            <p className="text-secondary md:text-lg max-w-3xl mx-auto mb-8">
              Building lasting partnerships across East and West Africa,
              delivering quality commodities and exceptional service to markets
              that matter.
            </p>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-secondary">
                  Trusted partnerships across the African continent
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-50">
                      Premium commodities with rigorous quality control and
                      certification
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-50">
                      Efficient logistics and timely delivery to ensure your
                      business continuity
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-50">
                      Best market rates with flexible payment terms tailored to
                      your needs
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-50">
                      24/7 customer service with local market expertise and
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-secondary max-w-2xl mx-auto">
                Hear from businesses across Africa who trust HAI Trading for
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  quote:
                    "HAI Trading has been our trusted partner for over 5 years. Their consistent quality and reliable delivery have been crucial to our business growth.",
                  author: "Ahmed Hassan",
                ...
                {
                  quote:
                    "The team at HAI Trading understands our market needs perfectly. Their customer service and product range are exceptional.",
                  author: "Fatima Osman",
                ...
                {
                  quote:
                    "Working with HAI Trading has transformed our supply chain. Their competitive pricing and timely deliveries have exceeded our expectations.",
                  author: "John Kamau",
          ...
          <div className="text-center bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-12 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-xl">
            ...
            <p className="text-zinc-600 dark:text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
              Let's discuss how HAI Trading can support your business with
              premium commodities and exceptional service.
            </p>
